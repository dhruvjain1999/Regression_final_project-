...
knitr::include_graphics("C:/Users/Dhruv Jain/Desktop/1.png")
# plot(allmodels)
```

## 7.2 Finding Reduce model   
...
## 7.3  Let eliminate all interaction 

-   Terms or the single whose p value is insignificant. For this case our starting model has a lot of variables so after removing many of the variables we will have a reduced model.
...
## 7.4 CI for  two of our chosen quantitative variables 
